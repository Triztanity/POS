    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        try {
            if (call.method.equals("getServiceVersion")) {
                // Return a simple service/version identifier. If the underlying
                // printer service exposes a version API, integrate here.
                result.success("senraise_printer_service_1.0");
            } else if (call.method.equals("getPlatformVersion")) {
                // Legacy: return Android platform version
