...
class StationRegistry {
  ...
  static const List<StationCoordinate> stations = [
    ...
    StationCoordinate(routeOrder: 11, name: 'Obispo',                               latitude: 14.000183118247508, longitude: 120.72972547681276),
    ...
    StationCoordinate(routeOrder: 16, name: 'Balayan Waltermart',                   latitude: 13.949491719185836, longitude: 120.73031370215853),
    StationCoordinate(routeOrder: 17, name: 'Spyder Fuel Gumamela',                 latitude: 13.945509543108338, longitude: 120.74354169000694),
    StationCoordinate(routeOrder: 18, name: 'Gimalas',                              latitude: 13.945257516211425, longitude: 120.75249845996632),
    ...
    StationCoordinate(routeOrder: 27, name: 'Mataas na Bayan Brgy. Hall',           latitude: 13.910160448688467, longitude: 120.85966656207862),
    StationCoordinate(routeOrder: 28, name: 'Mahayahay 7 11',                       latitude: 13.911763963226953, longitude: 120.86798416696558),
    StationCoordinate(routeOrder: 29, name: 'Matingain Mahal na Poon',              latitude: 13.912974994235583, longitude: 120.87856616136365),
    StationCoordinate(routeOrder: 30, name: 'Bukal The Black Tea Project',          latitude: 13.907353859158965, longitude: 120.88904776713045),
    StationCoordinate(routeOrder: 31, name: 'Tubigan Ice Plant',                    latitude: 13.907601644260248, longitude: 120.89049789596605),
    StationCoordinate(routeOrder: 32, name: 'Malinis Wilcon Depot',                 latitude: 13.904743493372923, longitude: 120.89486589093401),
    StationCoordinate(routeOrder: 33, name: 'Lemery Xentro Mall',                   latitude: 13.902158082537033, longitude: 120.89827272207334),
    StationCoordinate(routeOrder: 34, name: 'Laguile Food House',                   latitude: 13.897208453249082, longitude: 120.90428285335514),
    StationCoordinate(routeOrder: 35, name: 'Halang Flying V',                      latitude: 13.897077993269678, longitude: 120.91545879220234),
    StationCoordinate(routeOrder: 36, name: 'Latag Waiting Shed',                   latitude: 13.895711487650441, longitude: 120.92673462480163),
    StationCoordinate(routeOrder: 37, name: 'Tulo Waiting Shed',                    latitude: 13.892805000000000, longitude: 120.93017510000000),
    StationCoordinate(routeOrder: 38, name: 'Jollibee Taal',                        latitude: 13.887144900000000, longitude: 120.93905900000000),
    StationCoordinate(routeOrder: 39, name: 'Buli Brgy. Hall',                      latitude: 13.884018893687000, longitude: 120.94425665108648),
    StationCoordinate(routeOrder: 40, name: 'Tawilisan 7 11',                       latitude: 13.883351019393007, longitude: 120.95307925108628),
    StationCoordinate(routeOrder: 41, name: 'Mohon Elem School',                    latitude: 13.880775319655388, longitude: 120.96445856345854),
    StationCoordinate(routeOrder: 42, name: 'Sta. Teresita Church',                 latitude: 13.878759549055012, longitude: 120.96681811244726),
    StationCoordinate(routeOrder: 43, name: 'San Luis Intersection',                latitude: 13.870934484302700, longitude: 120.97758098176469),
    StationCoordinate(routeOrder: 44, name: 'Muzon',                                latitude: 13.861983900000000, longitude: 120.98459560000000),
    StationCoordinate(routeOrder: 45, name: 'Cupang Waiting Shed/ School',          latitude: 13.854885053125715, longitude: 120.98846460505910),
    StationCoordinate(routeOrder: 46, name: 'As-Is Brgy. Hall',                     latitude: 13.836799400000000, longitude: 120.99332850000000),
    StationCoordinate(routeOrder: 47, name: 'Balayong Clean Fuel',                  latitude: 13.824413888154169, longitude: 120.99330737765712),
    StationCoordinate(routeOrder: 48, name: 'Manghinao',                            latitude: 13.812388596451019, longitude: 120.99568647270985),
    StationCoordinate(routeOrder: 49, name: 'Citimart Bauan',                       latitude: 13.796396207586719, longitude: 121.00030099274306),
    StationCoordinate(routeOrder: 50, name: 'San Antonio',                          latitude: 13.792573554358533, longitude: 121.00720503320959),
    ...
    StationCoordinate(routeOrder: 55, name: 'Batangas Terminal',                    latitude: 13.790663174402377, longitude: 121.06168415902447),
  ];
